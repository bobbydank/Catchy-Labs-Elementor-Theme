...
abstract class Base {
	...
	protected function prepare_theme_options() {
		...
		$this->theme_options_fields = array_merge( $this->theme_options_fields, array(
			...
			array(
				'id'           => 'primary_color',
				'label'        => __( 'Primary Color', 'cl-elementor' ),
			...
			array(
				'id'           => 'secondary_color',
				'label'        => __( 'Secondary Color', 'cl-elementor' ),
				'desc'         => sprintf( __( 'A color that is used as the secondary color for a number of things', 'cl-elementor' ) ),
				'std'          => '',
				'type'         => 'colorpicker',
				'section'      => 'colors',
				'rows'         => '',
			...
			array(
				'id'           => 'tertiary_color',
				'label'        => __( 'Tertiary Color', 'cl-elementor' ),
				'desc'         => sprintf( __( 'A color that is used as the tertiary color for a number of things', 'cl-elementor' ) ),
				'std'          => '',
				'type'         => 'colorpicker',
				'section'      => 'colors',
				'rows'         => '',
			...
			array(
				...
				'desc'         => sprintf( __( 'A color that is used as the text color for a number of things', 'cl-elementor' ) ),
				'std'          => '',
				'type'         => 'colorpicker',
				'section'      => 'colors',
				'rows'         => '',
			...
			array(
				'id'           => 'disable_comments',
				'label'        => __( 'Disable Comments', 'cl-elementor' ),
				'desc'         => sprintf( __( 'This will disable all comments on the site.', 'cl-elementor' ) ),
				'std'          => 'off',
				'type'         => 'on-off',
				'section'      => 'settings',
				'rows'         => '',
			...
			array(
				'id'           => 'default_404',
				'label'        => __( 'Default 404', 'cl-elementor' ),
				'desc'         => sprintf( __( 'Select the default 404 page for this site', 'cl-elementor' ) ),
				'std'          => '',
				'type'         => 'page-select',
				'section'      => 'settings',
				'rows'         => '',
			...
			array(
				'id'           => 'header_fixed',
				'label'        => __( 'Fixed Header', 'cl-elementor' ),
				'desc'         => sprintf( __( 'Fix the header to the top? Header will appear over the page content.', 'cl-elementor' ) ),
				'std'          => 'off',
				'type'         => 'on-off',
				'section'      => 'header',
				'rows'         => '',
			...
			array(
				'id'           => 'header_absolute',
				'label'        => __( 'Absolute Header', 'cl-elementor' ),
				'desc'         => sprintf( __( 'Like fixed but it doesn\'t scroll. So the header will appear over the page content.', 'cl-elementor' ) ),
				'std'          => 'off',
				'type'         => 'on-off',
				'section'      => 'header',
				'rows'         => '',
			...
			array(
				'id'           => 'js_slick',
				'label'        => __( 'Slick JS', 'cl-elementor' ),
				'desc'         => sprintf( __( 'Would you like to load Slick JS library?', 'cl-elementor' ) ),
				'std'          => 'on',
				'type'         => 'on-off',
				'section'      => 'libraries',
				'rows'         => '',
			...
			array(
				'id'           => 'js_magnific',
				'label'        => __( 'Magnific JS', 'cl-elementor' ),
				'desc'         => sprintf( __( 'Would you like to load Magnific JS library?', 'cl-elementor' ) ),
				'std'          => 'on',
				'type'         => 'on-off',
				'section'      => 'libraries',
				'rows'         => '',
